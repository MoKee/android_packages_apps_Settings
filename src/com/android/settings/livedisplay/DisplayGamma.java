...
public class DisplayGamma extends DialogPreference {
    ...
    public DisplayGamma(Context context, AttributeSet attrs) {
        ...
        if (!mHardware.isSupported(MKHardwareManager.FEATURE_DISPLAY_GAMMA_CALIBRATION)) {
            return;
        }
    ...
    public static void restore(Context context) {
        ...
        if (!hardware.isSupported(MKHardwareManager.FEATURE_DISPLAY_GAMMA_CALIBRATION)) {
            return;
        }
    ...
    private static void writeDisplayGamma(Context context, int index, int[] entries) {
        ...
        MKSettings.Secure.putString(context.getContentResolver(),
                MKSettings.Secure.DISPLAY_GAMMA_CALIBRATION_PREFIX + index,
                builder.toString());
    }
