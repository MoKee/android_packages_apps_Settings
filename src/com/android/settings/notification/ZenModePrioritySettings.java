...
public class ZenModePrioritySettings extends ZenModeSettingsBase implements Indexable {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        vibration.setSelectedItem(MKSettings.System.getInt(getContentResolver(),
                    MKSettings.System.ZEN_PRIORITY_VIBRATION_MODE, 0));
        vibration.setCallback(new DropDownPreference.Callback() {
            @Override
            public boolean onItemSelected(int pos, Object newValue) {
                MKSettings.System.putInt(getContentResolver(),
                        MKSettings.System.ZEN_PRIORITY_VIBRATION_MODE, pos);
                return true;
            }
        });
