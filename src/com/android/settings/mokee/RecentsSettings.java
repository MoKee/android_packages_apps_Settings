...
public class RecentsSettings extends SettingsPreferenceFragment implements OnPreferenceChangeListener {
    ...
    private void updateRecentsLocation(int value) {
        Settings.System.putInt(getContentResolver(), Settings.System.RECENTS_CLEAR_ALL_LOCATION, value);
        if (mRecentsClearAllLocation != null) {
            mRecentsClearAllLocation.setSummary(getResources().getStringArray(R.array.recents_clear_all_location_entries)[value]);
        }
    }
}
