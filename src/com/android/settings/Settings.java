...
import com.android.settings.mokee.PowerSaverSettings;
import com.android.settings.mokee.SmartControl;
    ...
    private boolean updateHomeSettingHeaders(Header header) {
        try {
            ...
            if (homeApps.size() < 2) {
                ...
                prefsIntent.addCategory("com.mokee.category.LAUNCHER_PREFERENCES");
