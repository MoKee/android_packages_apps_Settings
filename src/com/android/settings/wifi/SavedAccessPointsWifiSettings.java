...
public class SavedAccessPointsWifiSettings extends RestrictedSettingsFragment
    ...
    public void onResume() {
        ...
        resolver.registerContentObserver(MKSettings.Global.getUriFor(
                MKSettings.Global.WIFI_AUTO_PRIORITIES_CONFIGURATION), false, mSettingsObserver);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case MENU_ID_AUTO_CONFIG_PRIORITIES:
                ...
                MKSettings.Global.putInt(getActivity().getContentResolver(),
                        MKSettings.Global.WIFI_AUTO_PRIORITIES_CONFIGURATION, autoConfig ? 1 : 0);
    ...
    private boolean isAutoConfigPriorities() {
        return MKSettings.Global.getInt(getActivity().getContentResolver(),
                MKSettings.Global.WIFI_AUTO_PRIORITIES_CONFIGURATION, 1) != 0;
    }
