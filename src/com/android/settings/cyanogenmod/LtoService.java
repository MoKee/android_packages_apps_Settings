...
import static android.hardware.MkHardwareManager.FEATURE_LONG_TERM_ORBITS;
...
public class LtoService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        if (mMkHardwareManager == null ||
                !mMkHardwareManager.isSupported(FEATURE_LONG_TERM_ORBITS)) {
        ...
        mTask = new LtoDownloadTask(mMkHardwareManager.getLtoSource(),
                new File(mMkHardwareManager.getLtoDestination()));
        mTask.execute();
    ...
    private boolean shouldDownload() {
        ...
        long due = lastDownload + mMkHardwareManager.getLtoDownloadInterval();
    ...
    private PendingIntent scheduleNextDownload(long lastDownload) {
        ...
        long nextLtoDownload = lastDownload + mMkHardwareManager.getLtoDownloadInterval();
