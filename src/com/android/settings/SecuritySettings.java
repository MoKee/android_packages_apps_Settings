...
import static mokee.content.Intent.ACTION_OPEN_LIVE_LOCKSCREEN_SETTINGS;
...
public class SecuritySettings extends SettingsPreferenceFragment
    ...
    private static final String KEY_LOCK_SCREEN_BLUR = MKSettings.Secure.LOCK_SCREEN_BLUR_ENABLED;
    ...
    private PreferenceScreen createPreferenceHierarchy() {
        ...
        if (MKSettings.Secure.getIntForUser(getContentResolver(),
                MKSettings.Secure.LOCKSCREEN_INTERNALLY_ENABLED, 1, UserHandle.USER_OWNER) != 1) {
    ...
    public void onResume() {
        ...
        if (mDirectlyShow != null) {
            mDirectlyShow.setChecked(mkLockPatternUtils.shouldPassToSecurityView(MY_USER_ID));
        }
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        if (KEY_UNLOCK_SET_OR_CHANGE.equals(key)) {
            ...
            MKSettings.Secure.putIntForUser(getActivity().getContentResolver(),
                    MKSettings.Secure.LOCKSCREEN_INTERNALLY_ENABLED,
