...
import static org.mokee.internal.util.TelephonyExtUtils.PROVISIONED;
import static org.mokee.internal.util.TelephonyExtUtils.NOT_PROVISIONED;
...
import org.mokee.internal.util.TelephonyExtUtils;
import org.mokee.internal.util.TelephonyExtUtils.ProvisioningChangedListener;
...
public class SimSettings extends RestrictedSettingsFragment implements Indexable,
    ...
    private class SimEnablerPreference extends SimPreference implements OnCheckedChangeListener {
        ...
        // Based on the received SIM provision state this method sets the check box
        // on SIM preference UI and updates new state to mCurrentUiccProvisionState.
