...
public class MoKeeVersionDetailPreferenceController extends BasePreferenceController {

    private static final String TAG = "mokeeVersionDialogCtrl";
    ...
    public MoKeeVersionDetailPreferenceController(Context context, String key) {
        super(context, key);
    ...
    public CharSequence getSummary() {
        return SystemProperties.get(KEY_MOKEE_VERSION_PROP,
    ...
    public void copy() {
        Sliceable.setCopyContent(mContext, getSummary(),
                mContext.getText(org.mokee.platform.internal.R.string.mokee_version));
    }
}
